      ...
      <Provider store={store}>
        <Router history={browserHistory}>
          ...
          >
            ...
            <Route
              path={path.classificationDetails}
              component={ClassificationDetails}
            />
            <Route path={path.itemDetails} component={ItemDetails} />
            <Route
              path={path.correspondenceDetails}
              component={CorrespondenceDetails}
            />
            <Route path={path.searchItems} component={SearchResults} />
          </Route>
        </Router>
      </Provider>
    );
